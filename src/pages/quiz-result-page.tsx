    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <Card className="w-full max-w-2xl bg-white shadow-lg rounded-3xl p-8 md:p-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <StatsCard label="Total Questions" value={totalQuestions} />
          <StatsCard label="Correct Answers" value={correctAnswers} />
          <StatsCard label="Wrong Answers" value={wrongAnswers} />
        </div>
